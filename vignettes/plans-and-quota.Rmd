...
than its first 5000 records. This
...
cell stays under the ceiling; `scopus_count()` tells you in advance whether a
split is needed. The other is `scopus_fetch(cursor = TRUE)`, which follows the
