...
2015 to 2024, so a year range reaching outside it is drawn from the nearest year
it holds. Only the topic comparison is synthesised, since it counts whole
literatures, which no set of records in hand can answer for. When you are ready
for real results, paste your Scopus key into the field at the top of the sidebar
and switch Demo mode off. The key stays in the running session and is never
...
the labels. Because each term needs one count request per year, the tab shows how
