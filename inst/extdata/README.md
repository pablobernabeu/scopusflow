...
`scopus_page.json` is a synthetic parser fixture for the offline test suite, and
no part of it came from 'Scopus': its records are invented, and its identifiers are
