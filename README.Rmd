...
uses as few requests, and as little quota, as it can, working within the
documented limits rather than around them. This is the same approach `rscopus`
takes. The quota and rate-limit headers
